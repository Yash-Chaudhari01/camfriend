...
export class ProdcutlistComponent {
  ...
  ngOnInit() {
    this.fetchEquipmentByCity();
  }

  // Fetch equipment based on city using POST API
  fetchEquipmentByCity() {
    const url = 'https://camfriend-1.onrender.com/test';  // Assuming this is your API endpoint

    const requestBody = {
      city: this.sharedservice.getLocation,  // Use the city from the searchData model
    ...
    .then((data) => {
      // Set the equipment data from the API response
